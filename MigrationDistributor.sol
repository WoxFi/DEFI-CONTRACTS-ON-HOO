...
contract MigrateDistributor is Policy {
    ...
    address public immutable sWoxOld;
    
    address public newStaking;
    address public sWoxNew;
    ...
    */
    ...
    constructor( address _treasury, address _inte, uint _epochLength, uint _nextEpochBlock, address _oldStaking, address _sWoxOld, address _newStaking, address _sWoxNew ) {
        ...
        require( _sWoxOld != address(0) );
        sWoxOld = _sWoxOld;
        require( _newStaking != address(0) );
        newStaking = _newStaking;
        require( _sWoxNew != address(0) );
        sWoxNew = _sWoxNew;
    ...
    function distribute() external returns ( bool ) {
        if ( nextEpochBlock <= block.number ) {
            ...
            uint oldReward= split(reward,ISINTE(sWoxOld).circulatingSupply(),ISINTE(sWoxNew).circulatingSupply());
    ...
    function setNewStaking(address _newStaking, address _sWoxNew) external onlyPolicy() {
        require( _newStaking != address(0) );
        newStaking = _newStaking;
        require( _sWoxNew != address(0) );
        sWoxNew = _sWoxNew;
